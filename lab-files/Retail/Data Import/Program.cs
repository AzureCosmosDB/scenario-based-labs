...
namespace MovieDataImport
{
    class Program
    {
        ...
        async static void ImportUsers()
        {
            ...
            users.Add(new Models.User { UserId = 1, Email = "horror@contosomovies.com", Name="Horror Fan" });
            users.Add(new Models.User { UserId = 2, Email = "family@contosomovies.com", Name = "Family Fan" });
            users.Add(new Models.User { UserId = 3, Email = "comedy@contosomovies.com", Name = "Comedy Fan" });
            users.Add(new Models.User { UserId = 4, Email = "romance@contosomovies.com", Name = "Romance Fan" });
            users.Add(new Models.User { UserId = 5, Email = "thriller@contosomovies.com", Name = "Thriller Fan" });
        ...
        async static void ImportMovies()
        {
            ...
            Uri productCatCollectionUri = UriFactory.CreateDocumentCollectionUri(databaseId, "product_category");
            ...
            foreach (string line in lines)
            {
                ...
                try
                {
                    ...
                    TimeSpan ts = DateTime.Now - p.ReleaseDate;
