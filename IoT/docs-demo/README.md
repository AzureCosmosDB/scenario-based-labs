...
- [Exercise 5: Observe Cosmos DB Change Feed using Azure Functions and App Insights](./05.change-feed.md)
- [Exercise 6: Observe data using Cosmos DB Data Explorer and Web App](./06.observe-data.md)
- [Exercise 7: Perform CRUD operations using the Web App](./07.web-app.md)
- [Exercise 8: Create the Fleet status real-time dashboard in Power BI](./08.rt-dashboard.md)
- [Exercise 9: Create the Trip/Consignment status report in Power BI](./09.report.md)
